...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 加载模型和标签
        classNames = Utils.ReadListFromFile(getAssets(), "rps.txt");
        String classificationModelPath = getCacheDir().getAbsolutePath() + File.separator + "rps.tflite";
        Utils.copyFileFromAsset(CameraActivity.this, "rps.tflite", classificationModelPath);
        try {
