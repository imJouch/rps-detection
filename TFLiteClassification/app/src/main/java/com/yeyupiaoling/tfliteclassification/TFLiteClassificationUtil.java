...
//            GpuDelegate delegate = new GpuDelegate();
            ...
            int[] probabilityShape = tflite.getOutputTensor(tflite.getOutputIndex("dense_1/Softmax")).shape();
            DataType probabilityDataType = tflite.getOutputTensor(tflite.getOutputIndex("dense_1/Softmax")).dataType();
